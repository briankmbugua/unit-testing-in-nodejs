...
desccribe("UserController", function () {
    desccribe("register", function () {
        ...
        it("should not register a user when a name param is not provided", async function () {
